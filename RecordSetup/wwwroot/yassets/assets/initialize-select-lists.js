...
function setupSubRegionRecordSelect(url, placeholder = "Select Sub-Region Record") {
    setupBasicSelect(subRegionRecordSelect, url, placeholder);
}
function setupSubRegionRecordTableSelect(url, placeholder = "Select Sub-Region Record Table") {
